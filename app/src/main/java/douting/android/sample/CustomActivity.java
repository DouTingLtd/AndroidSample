 ...
 * ..
 */
public class CustomActivity extends ToolbarActivity {
...
//        connectReady("16:07:07:00:C3:55");
    ...
    private void checkBluetooth() {
        ...
        if (flag != -1) {
            bluetoothAdapter.getProfileProxy(CustomActivity.this, new BluetoothProfile.ServiceListener() {
                @Override
    ...
    private void connectReady(String mac) {
        ...
        start_bt.setText(R.string.hearing_listening_start);
    }

    private void showDisconnectIcon() {
        isConnect = false;
        disconnect_im.setVisibility(View.VISIBLE);
        start_bt.setText(R.string.hearing_connect_bluetooth);
    }
